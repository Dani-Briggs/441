...
function flipImage(number)
{
  ...
  if(actualImages[secNumber] != actualImages[firstNumber] && firstNumber >= 0 && secNumber >= 0 && thirdNumber >= 0 && fourthNumber >= 0 && fifthNumber >= 0)
  {
    setTimeout(imageDisappear, 900);
  }
  else if(actualImages[secNumber] != actualImages[firstNumber] && firstNumber >= 0 && secNumber >= 0 && thirdNumber >= 0 && fourthNumber >= 0 && fifthNumber >= 0)
  {
   firstNumber = -1;
   secNumber = -1;
  }
